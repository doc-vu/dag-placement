...
/**
* A sequence of DataSample64B instances.
*/
public final class DataSample64BSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DataSample64BSeq() {
        super(DataSample64B.class);
    }

    public DataSample64BSeq (int initialMaximum) {
        super(DataSample64B.class, initialMaximum);
    }

    public DataSample64BSeq (Collection elements) {
        super(DataSample64B.class, elements);
    }

    public  DataSample64B get(int index) { 
        return (DataSample64B) super.get(index); 
    }
